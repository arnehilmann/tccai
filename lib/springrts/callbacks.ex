defmodule SpringRTS.Callbacks do
    ...
    defmodule Feature do
        ...
        def get_rules_param_float(unitId, featureRulesParamName, defaultValue) do
            send Application.get_env(SpringRTS, :engine), {:callback, :Feature_getRulesParamFloat, unitId, featureRulesParamName, defaultValue, self()}
            receive_response()
        end
        def get_rules_param_string(unitId, featureRulesParamName, defaultValue) do
            send Application.get_env(SpringRTS, :engine), {:callback, :Feature_getRulesParamString, unitId, featureRulesParamName, defaultValue, self()}
            receive_response()
        end
    end
    ...
    defmodule Game do
        ...
        def get_rules_param_float(gameRulesParamName, defaultValue) do
            send Application.get_env(SpringRTS, :engine), {:callback, :Game_getRulesParamFloat, gameRulesParamName, defaultValue, self()}
            receive_response()
        end
        def get_rules_param_string(gameRulesParamName, defaultValue) do
            send Application.get_env(SpringRTS, :engine), {:callback, :Game_getRulesParamString, gameRulesParamName, defaultValue, self()}
            receive_response()
        end
    ...
    defmodule Mod do
        ...
        def get_radar_mip_level do
            send Application.get_env(SpringRTS, :engine), {:callback, :Mod_getRadarMipLevel, self()}
            receive_response()
        end
    ...
    defmodule Team do
        @moduledoc false
        def get_rules_param_float(teamId, teamRulesParamName, defaultValue) do
            send Application.get_env(SpringRTS, :engine), {:callback, :Team_getRulesParamFloat, teamId, teamRulesParamName, defaultValue, self()}
            receive_response()
        end
        def get_rules_param_string(teamId, teamRulesParamName, defaultValue) do
            send Application.get_env(SpringRTS, :engine), {:callback, :Team_getRulesParamString, teamId, teamRulesParamName, defaultValue, self()}
            receive_response()
        end
    ...
    defmodule Unit do
        ...
        def get_rules_param_float(unitId, unitRulesParamName, defaultValue) do
            send Application.get_env(SpringRTS, :engine), {:callback, :Unit_getRulesParamFloat, unitId, unitRulesParamName, defaultValue, self()}
            receive_response()
        end
        def get_rules_param_string(unitId, unitRulesParamName, defaultValue) do
            send Application.get_env(SpringRTS, :engine), {:callback, :Unit_getRulesParamString, unitId, unitRulesParamName, defaultValue, self()}
            receive_response()
        end
